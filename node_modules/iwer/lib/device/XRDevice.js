 ...
 */
import { GlobalSpace, PRIVATE as XRSPACE_PRIVATE, XRSpace, } from '../spaces/XRSpace.js';
import { Quaternion, Vector3 } from '../utils/Math.js';
import { XRController } from './XRController.js';
import { PRIVATE as XRSESSION_PRIVATE, XRSession, XRVisibilityState, } from '../session/XRSession.js';
...
import { PRIVATE as XRREFERENCESPACE_PRIVATE, XRReferenceSpace, XRReferenceSpaceType, } from '../spaces/XRReferenceSpace.js';
import { PRIVATE as XRSYSTEM_PRIVATE, XRSystem, } from '../initialization/XRSystem.js';
...
export class XRDevice {
    ...
    get activeSession() {
        var _a;
        return (_a = this[PRIVATE].xrSystem) === null || _a === void 0 ? void 0 : _a[XRSYSTEM_PRIVATE].activeSession;
    }
    recenter() {
